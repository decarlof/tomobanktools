...
if __name__ == '__main__':
    ...
    experiment_title = 'Varied volume fractions of borosilicate glass spheres with diameter gaussian distributed from 38-45 micronsen cased in a polypropylene matrix.'
    ...
    if (fname != None):
        if os.path.isfile(fname):
            ...
            f.add_entry(dx.Entry.sample( concentration={'value':concentration}))
